...
export const register = (myform) => async (dispatch) => {
  try {
    ...
    const { data } = await axios({
      method: "POST",
      url: "https://dkgicggupnrxldwvkeft.supabase.co/auth/v1/signup",
      data: myform,
      headers: headers,
    });
    console.log(data);
...
export const login = (myform) => async (dispatch) => {
  try {
    ...
    const { data } = await axios({
      method: "POST",
      url: "https://dkgicggupnrxldwvkeft.supabase.co/auth/v1/token?grant_type=password",
      data: myform,
      headers: headers,
    });
    console.log(data);
...
export const loadUser = () => async (dispatch) => {
  try {
    ...
    const { data } = await axios({
      method: "get",
      url: "https://dkgicggupnrxldwvkeft.supabase.co/auth/v1/user",
      headers: {
        ...headers,
...
export const logout = () => async (dispatch) => {
  ...
  const { data } = await axios({
    method: "POST",
    url: "https://dkgicggupnrxldwvkeft.supabase.co/auth/v1/logout",
    headers: {
      ...headers,
      "Content-Type": "application/json",
      Authorization: `Bearer ${access_token}`,
